...
def main(anchors, labels = None, model_addr="/sd/m.kmodel", sensor_window=(224, 224), lcd_rotation=0, sensor_hmirror=False, sensor_vflip=False):
    ...
    kpu.init_yolo2(task, 0.7, 0.4, 5, anchors) # threshold:[0,1], nms_value: [0, 1]
    try:
        while(True):
            img = sensor.snapshot()
            t = time.ticks_ms()
...
if __name__ == "__main__":
    try:
        labels = ["AA"]
        anchors = [1.9966572523117068, 2.207242488861084, 2.6180787086486816, 3.148022174835205, 3.9933153390884395, 4.476880073547363, 3.004217743873596, 3.464406967163086, 3.533147692680359, 3.8681600093841544]
